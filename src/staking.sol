...
contract StakeSystem {
    ...
    uint256 private totalTokensReward;
    uint256 private totalTokensWithdraw;
    ...
    */
    ...
    function parseNumberToSeconds(uint256 _num) internal view returns (uint256) {
        if (_num == 1) {
    ...
    */
    ...
    function stake(uint256 _amount, uint256 _duration) external {
        ...
        require(duration >= oneYearStakeTimeStamp, PlazoInsuficiente());
    ...
    */
    ...
    function rewardCalculated(address _sender) internal view returns (bool) {
    ...
    */
    ...
    function claimReward() external {
        ...
        if (rewardControl) {
            ...
            contractBalance = contractBalance - totalTokensReward;
    ...
    */
    ...
    function ownerDeposit(uint256 _amount) external OnlyOwner {
        ...
        emit UpdateBalanceContract(
            "Se actualizado el balance del contrato",
            contractBalance
        );
    }
